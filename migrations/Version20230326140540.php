 ...
 */
final class Version20230326140540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories_recette (categories_id INT NOT NULL, recette_id INT NOT NULL, INDEX IDX_61B1B230A21214B7 (categories_id), INDEX IDX_61B1B23089312FE9 (recette_id), PRIMARY KEY(categories_id, recette_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recette (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, duree_preparation VARCHAR(50) NOT NULL, temps_cuisson VARCHAR(50) NOT NULL, nb_personne INT NOT NULL, photo VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_49BB6390A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE categories_recette ADD CONSTRAINT FK_61B1B230A21214B7 FOREIGN KEY (categories_id) REFERENCES categories (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE categories_recette ADD CONSTRAINT FK_61B1B23089312FE9 FOREIGN KEY (recette_id) REFERENCES recette (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categories_recette DROP FOREIGN KEY FK_61B1B230A21214B7');
        $this->addSql('ALTER TABLE categories_recette DROP FOREIGN KEY FK_61B1B23089312FE9');
